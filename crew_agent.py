...
2. Use rag_knowledge_tool for informational questions about room tariffs, property facilities,
...
def main():
    ...
    while True:
        ...
        if customer_query.lower() in ["exit", "quit"]:
            print("Agent: Thank you for contacting Anandkrishna Residency.")
            break
